 ...
 * using the available cards specified.  Note that the sets defined in the actual
 * Dominion rule books are created when the application loads.  These are created
 * in a static block at the end of the class.
 *
...
public class CardSet {
	...
	// Mapping from GameType to Card Sets
  ...
  // Card Set Members:
	...
	public static CardSet getCardSet(final GameType type, int count,
	                                 List<Expansion> randomExpansions,
